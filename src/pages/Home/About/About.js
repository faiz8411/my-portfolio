        ...
        <div id="about" className="about-container">
            ...
            <Row>
                ...
                <Col xs={12} md={6}>
                    ...
                    <a href="https://drive.google.com/uc?export=download&id=1FxedPr60098cpGu-8enAJADxLeEXb6ix" target="_blank"><button className="resume-button mx-2" >Download Resume</button></a>
                </Col>
            </Row>
        </div>
    );
